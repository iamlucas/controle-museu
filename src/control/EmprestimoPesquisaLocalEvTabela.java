...
public class EmprestimoPesquisaLocalEvTabela implements TableModel {

	private List<LocalEmprestimoEntity> locais = new ArrayList<LocalEmprestimoEntity>();

	public EmprestimoPesquisaLocalEvTabela() {
		this.locais = this.selecionarTodos();
	}

	public static void main(String[] args) {
		new EmprestimoPesquisaLocalEvTabela().selecionarTodos();
	}
