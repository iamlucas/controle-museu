...
public class ObraPesquisaObraEvPesquisaAutor  implements ActionListener {
	...
	public ObraPesquisaObraEvPesquisaAutor (JTextField txtPesquisar, JTable tabela) {
		super();
	...
	public void preenchertabela(){
		...
		List<ObraEntity> listaResultado = dao.selectByAutor(TxtPesquisar.getText());
