...
public class EmprestimoPesquisarLocalEvBtnPesquisar implements ActionListener {
	...
	public EmprestimoPesquisarLocalEvBtnPesquisar(EmprestimoBoundary telaemprestimo, JTextField txtdestinatario) {
		super();
	...
	public void acao() {
		EmprestimoPesquisaLocalBoundary telaPesquisa = new EmprestimoPesquisaLocalBoundary(telaemprestimo,
				txtdestinatario);
	}
